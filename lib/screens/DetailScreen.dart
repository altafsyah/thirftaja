                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: InkWell(
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(20),
                                    child: Image.asset('assets/item-pic-2.png',width: 120, height: 80, fit: BoxFit.cover,)
                                    ),
                                  onTap: (){
                                    setState(() {
                              ...
                              Container(
                                ...
                                child: InkWell(
                                  child: ClipRRect(
                                    borderRadius: BorderRadius.circular(20),
                                    child: Image.asset('assets/item-pic-3.png',width: 120, height: 80, fit: BoxFit.cover,)
                                  ),
                                  onTap: (){
                                    setState(() {
